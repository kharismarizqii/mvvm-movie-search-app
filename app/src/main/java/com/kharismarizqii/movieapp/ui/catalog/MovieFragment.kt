...
@AndroidEntryPoint
class MovieFragment : Fragment(R.layout.fragment_catalog), MovieAdapter.OnItemClickListener{
    ...
    override fun onItemClick(movie: Movie) {
        val action = MovieFragmentDirections.actionMovieFragment2ToDetailsFragment(movie)
